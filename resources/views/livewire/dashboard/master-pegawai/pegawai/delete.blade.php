        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-body">
                    ...
                    <p class="text-center">Hapus {{ $nama }} dari Daftar Pegawai ?</p>
                    @if (session()->has('relation_on'))
                        <div class="alert alert-danger d-flex align-items-center alert-dismissible fade show"
                            role="alert">
                            Hapus gagal !!! <br> Data ini telah berelasi dengan data absensi.
                            <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"
                                style="font-size: 9pt;"></button>
                        </div>
                    @endif
                    @if (session()->has('relation_on_user'))
                        <div class="alert alert-danger d-flex align-items-center alert-dismissible fade show"
                            role="alert">
                            Hapus gagal !!! <br> Data ini telah berelasi dengan data user.
                            <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"
                                style="font-size: 9pt;"></button>
                        </div>
                    @endif
